...
--hostdev net_00_1c_25_10_b1_e4,boot_order=4,rom_bar=off,acpi_nodeset=0,2
...
--host-device 0x062a:0x0001,driver_name=vfio,driver_iommufd=yes
--host-device 0483:2016
--host-device pci_8086_2829_scsi_host_scsi_device_lun0,rom.bar=on,acpi_nodeset=0-2
