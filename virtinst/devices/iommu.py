...
class DeviceIommu(Device):
    ...
    pciBus = XMLProperty("./driver/@pciBus")
    accel = XMLProperty("./driver/@accel",is_onoff=True)
    ats = XMLProperty("./driver/@ats",is_onoff=True)
    ril = XMLProperty("./driver/@ril",is_onoff=True)
    pasid = XMLProperty("./driver/@pasid",is_onoff=True)
